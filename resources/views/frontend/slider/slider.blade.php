        ...
        <div class="slider-content" style="background: url({{asset($banner->image)}});background-size: cover;background-position: center;background-repeat: no-repeat;height: 800px;">
            <div class="container">
                <div class="content-part">
                    ...
                    @php $number = \App\Models\WebsiteLinks::latest()->first() @endphp
                    <div class="sl-btn wow fadeInUp" data-wow-delay="900ms" data-wow-duration="2000ms">
                        <a class="readon orange-btn main-home" href="tel:{{ $number->number }}">@if(session()->get('language') == 'bangla') কোর্স খুঁজুন @else Call: {{ $number->number }} @endif </a>
                    </div>
                </div>
            </div>
        </div>
